 ...
 * @Date 2020/6/14
 */
public class IFMServeRejectException extends Exception {

    private static final long serialVersionUID = 4453214753962022203L;

    public IFMServeRejectException(String message) {
        super(message);
        this.errorCode = ExceptionConst.REJECT_ERROR_CODE;
        this.message = message;
    }

    public IFMServeRejectException(String code, String message) {
        super(message);
        this.errorCode = ExceptionConst.REJECT_ERROR_CODE;
        this.message = message;
    }

    public IFMServeRejectException(String code, String message, List<String> messageStacks) {
        super(message);
        this.errorCode = code;
        this.message = message;
    ...
    public IFMServeRejectException(String code, String message, Throwable t) {
        super(message, t);
        this.errorCode = ExceptionConst.REJECT_ERROR_CODE;
        this.message = message;
        if (t != null) {
    ...
    public IFMServeRejectException(IFMResultErrorInfo ifmResultErrorInfo) {
        super("");
    ...
    public IFMServeRejectException(String message, IFMResultErrorInfo ifmResultErrorInfo) {
        super(message);
        if (ifmResultErrorInfo.getMessageStacks() != null) {
            this.messageStacks = ifmResultErrorInfo.getMessageStacks();
        }
    ...
    public IFMServeRejectException(String message, Throwable t) {
        super(message, t);
        this.errorCode = ExceptionConst.REJECT_ERROR_CODE;
        this.message = message;
        if (t != null) {
