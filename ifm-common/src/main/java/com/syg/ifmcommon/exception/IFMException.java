...
public class IFMException extends Exception {
    ...
    public IFMException(String message) {
        super(message);
        this.errorCode = ExceptionConst.REJECT_ERROR_CODE;
        this.message = message;
    }

    public IFMException(String code, String message) {
        super(message);
        this.errorCode = code;
        this.message = message;
    }

    public IFMException(String code, String message, List<String> messageStacks) {
        super(message);
        this.errorCode = code;
        this.message = message;
    ...
    public IFMException(String code, String message, Throwable t) {
        super(message, t);
        this.errorCode = code;
        this.message = message;
        if (t != null) {
    ...
    public IFMException(IFMResultErrorInfo ifmResultErrorInfo) {
        super("");
    ...
    public IFMException(String message, IFMResultErrorInfo ifmResultErrorInfo) {
        super(message);
        if (ifmResultErrorInfo.getMessageStacks() != null) {
            this.messageStacks = ifmResultErrorInfo.getMessageStacks();
        }
    ...
    public IFMException(String message, Throwable t) {
        super(message, t);
        this.errorCode = ExceptionConst.REJECT_ERROR_CODE;
        this.message = message;
        if (t != null) {
